...
/// <summary>
/// Compiled, ready-to-use view of the output-path allow-list from <see cref="Crawl4AiOptions"/>.
/// The regexes are compiled once (at construction) rather than on every write. Registered as a
/// singleton. Adapted from the FileMcp path policy.
/// </summary>
public sealed class PathPolicy
{
    ...
    public PathPolicy(IOptions<Crawl4AiOptions> options)
        : this(options.Value)
    {
    }

    public PathPolicy(Crawl4AiOptions options)
    {
